...
# Theres is no analogous widget that does
...
def on_submit():
    ...
    # Vars all use 'get()' to retrieve their variables
    name = name_var.get()
    ...
    # With the variable, OptionMeny makes things simple
    color = color_var.get()
    ...
    if plantain_eater:
        ...
        message += 'May you succesfully avoid plantains!'
