...
class Banana:
    ...
    def check_color(cls, color):
        """Test as color string to see if it is valid"""
    ...
    # Static methods have no acces to class or instance
    @staticmethod
...
my_banana = Banana()
my_banana.set_color('black')
my_banana.peel()
print(my_banana.peeled)

my_new_banana = Banana('green')
print(my_new_banana)
print(my_new_banana.peeled)


red_banana = RedBanana('red')
red_banana.peel()
