...
class BoundText(tk.Text):
    ...
    def _set_content(self, *_):
        """Set the tet contents to the variable"""
...
class LabelInput(tk.Frame):
    ...
    def __init__(self, parent, label, var, input_class=ttk.Entry,
        ...
        if input_class in (ttk.Checkbutton, ttk.Button):
            # Buttons don't need labels, they're bult-in
...
class DatarecordForm(tk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Record info section
        r_info = self._add_frame("Record Informaton")
        ...
        LabelInput(
            e_info, "Light (klx)",
            input_class=ttk.Spinbox, var=self._vars['Light'],
        ...
        LabelInput(
            p_info, "Blossoms", input_class=ttk.Spinbox, var=self._vars['Blossoms'],
...
class Application(tk.Tk):
    ...
    def _on_save(self):
        ...
        self.status.set(
            "{} records saved this session".format(self._record_saved)
        )
