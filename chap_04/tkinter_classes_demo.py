"""Demostration of using classes with tkinter"""
...
class JSONVar(tk.StringVar):
    ...
    def set(self, value: str, *args, **kwargs) -> None:
        ...
        return super().set(string, *args, **kwargs)
...
# Uncomment to try it, but commentt this code again before sub-classing tk
# root = tk.Tk()
# li1 = LabelInput(root, label='Text', inp_cls=tk.Entry, inp_args={'bg': 'red'})
# li1.grid()
